...
// 	global maindir ="..."		// Define main directory
	...
	global datafran="${folder}${sep}26 Mar 2022 Upload"			// Define were data will be saved
...
// 		else {
// 			gegen tob = max(aux), by(year)   // Because ob is number of observations in top 5%
// 		}
